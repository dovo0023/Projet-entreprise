...
- [ ] Le foyer influence bien la génération du menu (régime + allergies), mais pas encore les quantités précises par portion ni la liste de courses (toujours calculées pour une personne) — le badge "x{n} portions" dans Aujourd'hui reste indicatif.
